...
namespace JobSearchApp.Controllers.Admin
{
    public class ResumesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ResumeID,UserID,Language,Email,Phone,HighestEducation,WorkExperience")] Resume resume)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ResumeID,UserID,Language,Email,Phone,HighestEducation,WorkExperience")] Resume resume)
        {
